            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{__('app.application_settings')}}</li>
                    </ol>
                </div><!-- /.col -->
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">{{__('app.general_settings')}}</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{route('update.app.setting')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{__('app.app_name')}} <span class="text-danger">*</span></label>
                                    <input type="text" name="app_name" value="{{get_settings('app_name')}}" class="form-control">
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="app_date_format">{{__('app.date_format')}} <span class="text-danger">*</span></label>
                                    <select name="app_date_format" class="form-control">
                                        <option value="m/d/Y" {{get_settings('app_date_format') == 'm/d/Y' ? 'selected' : ''}} > m/d/Y (eg. {{\Carbon\Carbon::now()->format("m/d/Y")}} )</option>
                                        <option value="d/m/Y" {{get_settings('app_date_format') == 'd/m/Y' ? 'selected' : ''}} > d/m/Y (eg. {{\Carbon\Carbon::now()->format("d/m/Y")}} )</option>
                                        <option value="Y/m/d" {{get_settings('app_date_format') == 'Y/m/d' ? 'selected' : ''}} > Y/m/d (eg. {{\Carbon\Carbon::now()->format("Y/m/d")}} )</option>
                                        <option value="Y/d/m" {{get_settings('app_date_format') == 'Y/d/m' ? 'selected' : ''}} > Y/d/m (eg. {{\Carbon\Carbon::now()->format("Y/d/m")}} )</option>
                                        <option value="m-d-Y" {{get_settings('app_date_format') == 'm-d-Y' ? 'selected' : ''}} > m-d-Y (eg. {{\Carbon\Carbon::now()->format("m-d-Y")}} )</option>
                                        <option value="d-m-Y" {{get_settings('app_date_format') == 'd-m-Y' ? 'selected' : ''}} > d-m-Y (eg. {{\Carbon\Carbon::now()->format("d-m-Y")}} )</option>
                                        <option value="Y-m-d" {{get_settings('app_date_format') == 'Y-m-d' ? 'selected' : ''}} > Y-m-d (eg. {{\Carbon\Carbon::now()->format("Y-m-d")}} )</option>
                                        <option value="Y-d-m" {{get_settings('app_date_format') == 'Y-d-m' ? 'selected' : ''}} > Y-d-m (eg. {{\Carbon\Carbon::now()->format("Y-d-m")}} )</option>
                                        ...
                                        <option value="M d, Y" {{get_settings('app_date_format') == 'M d, Y' ? 'selected' : ''}} > M d, Y (eg. {{\Carbon\Carbon::now()->format("M d, Y")}} )</option>
                                        <option value="Y M, d" {{get_settings('app_date_format') == 'Y M, d' ? 'selected' : ''}} > Y M, d (eg. {{\Carbon\Carbon::now()->format("Y M, d")}} )</option>
                                        <option value="d F, Y" {{get_settings('app_date_format') == 'd F, Y' ? 'selected' : ''}} > d F, Y (eg. {{\Carbon\Carbon::now()->format("d F, Y")}} )</option>
                                        <option value="Y F, d" {{get_settings('app_date_format') == 'Y F, d' ? 'selected' : ''}} > Y F, d (eg. {{\Carbon\Carbon::now()->format("Y F, d")}} )</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="app_timezone">{{__('app.timezone')}} <span class="text-danger">*</span></label>
                                    <select name="app_timezone" class="form-control select2">
                                        <option value="{{get_settings('app_timezone')}}"> {{get_settings('app_timezone')}}</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="app_date_format">{{__('app.currency')}} <span class="text-danger">*</span></label>
                                    <select name="app_currency" class="form-control select2">
                                        <option value="BDT" {{get_settings('app_currency') == 'BDT' ? 'selected' : ''}} > BDT </option>
                                        <option value="$" {{get_settings('app_currency') == '$' ? 'selected' : ''}} > $ (USD) </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="form-group">
                                    <label for="app_logo">{{__('app.app_logo')}} <span class="text-danger">*</span></label>

                                    <div class="upload-img-box">
                                        @if(get_settings('app_logo') != '')
                                            <img src="{{asset(get_settings('app_logo'))}}">
                                        @else
                                            <img src="">
                                        @endif
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="form-group">
                                    <label for="app_fav_icon">{{__('app.app_fav_icon')}} <span class="text-danger">*</span></label>

                                    <div class="upload-img-box">
                                        @if(get_settings('app_fav_icon') != '')
                                            <img src="{{asset(get_settings('app_fav_icon'))}}">
                                        @else
                                            <img src="">
                                        @endif
